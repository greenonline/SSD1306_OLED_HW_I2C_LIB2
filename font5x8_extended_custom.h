...
#define __Use_extended_5x8_character_set__
#define __Use_extended_custom_5x8_character_set__

//  ASCII 6x8 font with leading zero bytes (character padding) removed
//  Each byte represents a column of 8 pixels
//  MSB at the bottom of char
...
#if defined(__Use_extended_5x8_character_set__)
    0x00, 0x10, 0x6E, 0x81, 0x00, // { 91
    0x00, 0x00, 0xFF, 0x00, 0x00, // | 92
    0x00, 0x81, 0x6E, 0x10, 0x00, // } 93
    0x06 ,0x01, 0x02, 0x02, 0x04, // ~ 94
    0x14, 0x14, 0x14, 0x14, 0x14, // horiz lines 95
    0x00, 0x06, 0x09, 0x09, 0x06, // ° 96 \140
    0x4C, 0x72, 0x01, 0x72, 0x4C, // Ω3 97
//    0x5C, 0x62, 0x01, 0x62, 0x5C, // Ω4 97
#if defined(__Use_extended_custom_5x8_character_set__)
    0xF0, 0xF8, 0xFC, 0xFE, 0xFF, // LT1 98
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, // block 99 \143
    0x3F, 0x3F, 0x3F, 0x3F, 0x3F, // topbar (UB) 100 \144
    0xFF, 0xFE, 0xFC, 0xF8, 0xF0, // toprightcorner(RT) 101
    0x0F, 0x1F, 0x3F, 0x7F, 0xFF, // lowerleft (LL) 102
    0xFE, 0xFE, 0xFE, 0xFE, 0xFE, // lowbar (LB) 103
    0xFF, 0x7F, 0x3F, 0x1F, 0x0F, // lowright (LR) 104 \150
    0x3F, 0x3F, 0x3F, 0x3F, 0x3F, // middle blank top (MBT) 105 \151
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, // middle blank bottom (MBB) 106 \152
    0x07, 0x3F, 0xFF, 0xFF, 0xFE, // cross1 (C1) 107 \153
    0xF8, 0xC0, 0x00, 0x00, 0x00, // cross2 (C2) 108 \154
    0x00, 0x00, 0x00, 0x03, 0x1F, // cross3 (C3) 109 \155
    0x7F, 0xFF, 0xFF, 0xFC, 0xE0, // cross4 (C4) 110 \156
    0xE0, 0xFC, 0xFF, 0xFF, 0x8F, // criss1 (C1) 111 \157
    0x1F, 0x03, 0x00, 0x00, 0x00, // criss2 (C2) 112 \160
    0x00, 0x00, 0x00, 0xC0, 0xF8, // criss3 (C3) 113 \161
    0xFE, 0xFF, 0xFF, 0x3F, 0x07, // criss4 (C4) 114 \162
#endif
#endif
};